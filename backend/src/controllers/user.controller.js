...
// Helper function to get full image URL for Stream
const getFullImageUrl = (imagePath) => {
  if (!imagePath) return "";
  if (imagePath.startsWith("http://") || imagePath.startsWith("https://")) {
    return imagePath;
  }
  // Use backend URL (not frontend URL) for serving images
...
export async function uploadProfilePicture(req, res) {
  try {
    ...
    // Update Stream user with new profile picture (with full URL for Stream)
    try {
      ...
      console.log("⚠️ Error updating Stream user profile picture:", streamError.message);
    }
